      ...
      <section className="container mx-auto w-full flex flex-col h-screen justify-center items-center gap-10">
        ...
        <div className="w-full md:w-1/2">
          <div className="text-lg font-light text-center">
            Highly skilled Front-End Web Developer with over 2 year of experience specializing in React.js and Vue.js. Proficient in building dynamic and responsive user interfaces, optimizing web performance, and ensuring cross-browser
            compatibility. Experienced in server-side rendering using Node.js and Express.js with Next.js and Nuxt.js frameworks. Strong problem-solving abilities and a collaborative mindset. Passionate about creating engaging and
